...
public final class UpgradeRecipe extends IForgeRegistryEntry.Impl<IRecipe> implements IRecipe {
    ...
    // Keeps it out of the recipe book, which can only show one item per slot.
    @Override
