...
public final class UpgradeRecipe implements IRecipe {
    ...
    static boolean arranged(IInventory grid) {
        ...
        for (int slot = 0; slot < 9; slot++) {
            ...
            boolean ok = slot == CENTER
                    ? stack != null && stack.getItem() == Item.appleGold && stack.getItemDamage() == 0
                    : stack != null && stack.getItem() == Item.ingotGold && stack.stackSize >= INGOTS_PER_SLOT;
            if (!ok) {
                return false;
            }
        }
    ...
    public ItemStack getRecipeOutput() {
        return new ItemStack(Item.appleGold, 1, 1);
    }
}
